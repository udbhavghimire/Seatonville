...
<head>
    ...
    <meta property="og:image" content="https://myseatonville.ca/images/seatonVilleLogo.svg">


    <meta property="og:site_name" content="Seatonville" />
        ...
        <nav class="navbar navbar-expand-md bg-white" id="navbar">
            <div class=" container">
                <a href="/" class="navbar-brand">
                    ...
                    <img src="images/seatonVilleLogo.svg" class="navbar-brand " alt="Seatonville">
                </a>
            ...
            <div class="hero-container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <h1 class="main-titlee pb-0  mb-0 mt-2 mt-md-0" data-aos="fade-up" data-aos-duration="2000"
                        data-aos-delay="50">Seatonville - Pickering</span>
                    </h1>
        ...
        <div class="container pt-5">
            ...
            <div>
                <div class="row row-cols-2 row-cols-md-3 justify-content-center gy-md-4 gy-4 gx-3 pt-md-2 pt-0">
                    <div class="col">
                        <div class="afte">
                            <img src="./images/blur-floorplan2.png" alt="Seatonville Floor Plan"
        ...
        <div class="container mt-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
            <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center brand-color" data-aos="fade-up">
                <a href="https://homebaba.ca/pickering/seaton-winding-woods" target="_blank"
                    class="fw-bold text-decoration-none brand-color"> Seatonville</a> FAQ
            </h2>
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header" id="flush-headingFour">
                        <button class="accordion-button collapsed fs-5 mob-sm-text" type="button"
                            ...
                            When is the completion of the Seatonville?
                        </button>
                    </h3>
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header " id="flush-headingOne">
                        <button class="accordion-button collapsed fs-5 mob-sm-text" type="button"
                            ...
                            Who is the builder of Seatonville?
                        </button>
                    </h3>
            ...
            <div class="pt-5 mt-5 " data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                <div class="row mx-0 ">
                    ...
                    <div class="registertext px-4   d-flex justify-content-center align-items-center text-center mb-0">
                        <p class="sm-text mx-3">Register today and get the first update on Seatonville coming
                            up in
                            Pickering
                        </p>
                    </div>
                        ...
                        <form action="./contactForm.php" method="POST">
                            ...
                            <div class="row ">
                                <p class=" text-muted sm-text text-center mt-0 ">*I consent to receive future
                                    communications about Seatonville. I understand I can opt out at anytime by
                                    sending
                                    an email.</p>
                            </div>
                            <div class="row ">
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 justify-content-between ">
                <div class="col-md-5 my-3 fotwidth center-sm px-4 px-md-0">
                    ...
                    <p class=" ">
                        <img src="./images/seatonVilleLogo.svg" class="navbar-brand pb-1" alt="Mira Townhomes Logo">
                    </p>
